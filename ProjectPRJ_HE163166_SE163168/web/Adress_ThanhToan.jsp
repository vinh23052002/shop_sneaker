    ...
    <body>
        <div id="logreg-forms">
            ...
            <form action="ThanhToan" method="post" class="">
                <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Dia Chi </h1>
                ...
                <button class="btn btn-primary btn-block" type="submit"><i class="fa-solid fa-cart-shopping"></i> Buy</button>

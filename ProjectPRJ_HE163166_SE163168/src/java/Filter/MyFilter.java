...
//            }
            if (url.contains("LoadGioHang")) {
                res.sendRedirect("Login.jsp");
            }
            if (url.contains("UpInformation")) {
                res.sendRedirect("Login.jsp");
            }
...
//            }
            ...
            if (url.contains("UpProduct")) {
                res.sendRedirect("Login.jsp");
            }
            if (url.contains("AddNewProduct")) {
                res.sendRedirect("Login.jsp");
            }
            if (url.contains("EditProduct")) {
                res.sendRedirect("Login.jsp");
            }
            if (url.contains("ManagerOrder")) {
                res.sendRedirect("Login.jsp");
            }
            if (url.contains("CheckDone")) {
                res.sendRedirect("Login.jsp");
            }

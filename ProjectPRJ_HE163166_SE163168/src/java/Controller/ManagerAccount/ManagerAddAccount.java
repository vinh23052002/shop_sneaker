 ...
 * @author asus
 */
@WebServlet(name="ManagerAddAccount", urlPatterns={"/AddAccount"})
public class ManagerAddAccount extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        dao.SignUp(Username, Pass, Gender, Email, Add, Phone,Roll);

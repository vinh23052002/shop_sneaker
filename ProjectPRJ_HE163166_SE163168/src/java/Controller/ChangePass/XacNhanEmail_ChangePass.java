 ...
 * @author asus
 */
public class XacNhanEmail_ChangePass extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String Ecode=(String)ses.getAttribute("Ecode");
        String Newpass=(String)ses.getAttribute("Newpass");
        String Ucode=request.getParameter("Ucode");
        
        if(Ucode.equals(Ecode)){
            dao.ChangePassword(Newpass,account.getUserName());

 ...
 */
package Controller.ManagerOrder;
 ...
 * @author asus
 */
public class ManagerOrder_ChangeDate extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao = new DAO();
        String date = request.getParameter("txt");
        dao.LoadOrderbyDate(date);
        for (Map.Entry<Integer, Order> o : dao.getOrder().entrySet()) {
            out.print(""
